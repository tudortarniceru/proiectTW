...
function loadPerspective() {
    if (localStorage["perspective"] == 0) {
        ...
        document.getElementById("display-perspective").href = "static/perspectives/vertical.css";
    ...
    if (localStorage["perspective"] == 1) {
        ...
        domTxt += '</div>';
        document.getElementById("wrapper").innerHTML = domTxt;
        document.getElementById("display-perspective").href = "static/perspectives/horizontal.css";
