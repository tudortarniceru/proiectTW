...
function displayPhotos() {
    var domTxt = "";
    for (var i = 0; i < images.length; ++i) {
        domTxt += "<img class='image-thumbnail' id='img" + i + "' onclick='showImage(" + i + ");' src='" + images[i].source + "'>";
    }
...
function showImage(nr) {
    ...
    var domTxt = "";
    document.getElementById("image-area").innerHTML = "<img onload='calculateVerticalDisplay();' class='image-displayer' src='" + images[nr].source + "'>";
